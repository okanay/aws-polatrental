                                    ...
                                    <td class="esd-stripe" align="center">
                                        <table bgcolor="#2a2827" class="es-footer-body" align="center" cellpadding="0" cellspacing="0" width="600" style="background-color: #2a2827;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p30t es-p25b es-p15r es-p15l" align="left">
                                                                ...
                                                                <tr>
                                                                    <td width="570" class="esd-container-frame" align="center" valign="top">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p10" bgcolor="#efefef">
                                                                                        <p style="color: #e69138; font-size: 20px; line-height: 120%;">Aşağıdaki aracı kiralamak istediğini belirtti.</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p30t es-p25b es-p15r es-p15l" align="left">
                                                        <!--[if mso]><table width="570" cellpadding="0" cellspacing="0"><tr><td width="148" valign="top"><![endif]-->
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10" bgcolor="#efefef">
                                                                                        <p style="color: #e69138; font-size: 20px; line-height: 120%;">${data.data.id}</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                        ...
                                                        <!--[if mso]></td><td width="148" valign="top"><![endif]-->
                                                        <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="128" class="es-m-p20b esd-container-frame" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10" bgcolor="#efefef">
                                                                                        <p style="color: #e69138; font-size: 20px; line-height: 120%;">${data.data.brand}</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                        ...
                                                        <!--[if mso]></td><td width="127" valign="top"><![endif]-->
                                                        <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="127" class="es-m-p20b esd-container-frame" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10" bgcolor="#efefef">
                                                                                        <p style="color: #e69138; font-size: 20px; line-height: 120%;">${data.data.name}</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                        ...
                                                        <!--[if mso]></td><td width="20"></td><td width="127" valign="top"><![endif]-->
                                                        <table cellpadding="0" cellspacing="0" class="es-right" align="right">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="127" class="esd-container-frame" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10" bgcolor="#efefef">
                                                                                        <p style="color: #e69138; font-size: 20px; line-height: 120%;">${data.data.type}</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p25b es-p15r es-p15l" align="left">
                                                        <!--[if mso]><table width="570" cellpadding="0" cellspacing="0"><tr><td width="148" valign="top"><![endif]-->
                                                        <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="128" class="es-m-p0r es-m-p20b esd-container-frame" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10" bgcolor="#efefef">
                                                                                        <p style="color: #e69138; font-size: 20px; line-height: 120%;">${data.data.gear}</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    ...
                                                                    <td width="128" class="es-m-p20b esd-container-frame" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10" bgcolor="#efefef">
                                                                                        <p style="color: #e69138; font-size: 20px; line-height: 120%;">${data.data.gas}</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    ...
                                                                    <td width="127" class="es-m-p20b esd-container-frame" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10" bgcolor="#efefef">
                                                                                        <p style="color: #e69138; font-size: 20px; line-height: 120%;">${data.data.ac}</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    ...
                                                                    <td width="127" class="esd-container-frame" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10" bgcolor="#efefef">
                                                                                        <p style="color: #e69138; font-size: 20px; line-height: 120%;">${data.data.year}</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
