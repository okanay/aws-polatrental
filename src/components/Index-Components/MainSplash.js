...
export const MainSplash = () => {
    ...
    return <div className={'min-h-[240px] max-h-[240px] tablet:min-h-[265px] tablet:max-h-[265px] relative'}>
        <Image src={Nature} alt={"Çölde huzurlu bir sakin yol fotoğrafı"} priority={true} width={4000} height={6000}
        ...
        <Link href={"/kiralik-araclar"}
            ...
            <div className={'group'}>
                <button
                    ...
                    <span className="font-bold bg-gradient-to-tr from-skin-theme-500 via-skin-theme-300/65 to-skin-theme-400 rounded-full  px-[0.175rem] py-[0.15rem] border border-skin-theme-400 group-hover:border-white transition-colors duration-500 flex justify-center items-center w-fit">
                       <MagnifyingGlassCircleIcon className={'text-skin-theme-50 font-figtree transition-colors duration-500 sm:w-5 sm:h-5 h-4 w-4'}/>
